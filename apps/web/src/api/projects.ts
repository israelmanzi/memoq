...
export const projectsApi = {
  ...
  /**
   * Upload document with progress tracking using XMLHttpRequest.
   * Provides real-time upload progress and processing status.
   */
  uploadDocumentWithProgress: (
    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.open('POST', `${baseUrl}/documents/project/${projectId}/upload`);
      if (token) {
